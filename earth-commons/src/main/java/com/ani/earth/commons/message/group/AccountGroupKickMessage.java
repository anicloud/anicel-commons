 ...
 */
public class AccountGroupKickMessage extends AccountGroupMessage {
    public Long accountId;

    public AccountGroupKickMessage(String description, ObjectQueryDto src, Long groupId, Long accountId) {
        super(Type.ACCOUNT_GROUP_KICK, description, src ,groupId);
