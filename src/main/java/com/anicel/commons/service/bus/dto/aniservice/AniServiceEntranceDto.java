package com.anicel.commons.service.bus.dto.aniservice;
...
public class AniServiceEntranceDto implements Serializable {
    ...
    public AniServiceEntranceDto(String entranceName, String entranceUrl, String logoPath, Set<String> tagSet, String description) {
        this(null, entranceName, entranceUrl, logoPath, tagSet, description);
    }
